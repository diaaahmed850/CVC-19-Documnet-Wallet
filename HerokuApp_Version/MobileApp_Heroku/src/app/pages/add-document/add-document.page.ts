    ...
    this.camera.getPicture(options).then((imageData) => {
     ...
     this.showLoader()
      ...
      if(this.type=="Natinal ID"){
        ...
        this.service.uploadImage({'img':imageData}).subscribe(res=>{
          this.service.getId().subscribe(res=>{
            ...
            this.service.restartServer().subscribe(res=>{
             ...
             if(err.error.Error){
              ...
              this.presentAlert('Alert',"Please try again later")
            }
           })
        },err=>{
          this.hideLoader()
      ...
      this.service.uploadImage({'img':imageData}).subscribe(res=>{
        this.service.getPassport().subscribe(res=>{
